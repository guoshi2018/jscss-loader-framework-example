	...
	Object.defineProperty(global, 'Guoshi', {
		value: {
			Html: {
				...
				relLocFrom: function (ele: HTMLElement, evt: JQuery.MouseEventBase): JQuery.Coordinates {
			...
			Math: {
				...
				avg: function (arr: number[] | string[] | Array<number | string>) {
