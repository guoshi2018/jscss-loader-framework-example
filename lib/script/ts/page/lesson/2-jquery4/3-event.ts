...
JscssLoader.getInstance().startEntry({
  ...
  main: () => {
    ...
    function configButtons2() {
      $('#switcher-default').addClass('selected');
      $('#switcher .button').click(function (evt: JQuery.ClickEvent) {
    ...
    function configButtons3() {
      $('#switcher').click(function (evt: JQuery.ClickEvent) {
    ...
    function preventGuitar() {
      $('a#guitar').click(function (evt: JQuery.ClickEvent) {
        const anc = evt.target as HTMLAnchorElement;
     ...
     */
    function configKey() {
      $(document).keyup((evt: JQuery.KeyUpEvent) => {
